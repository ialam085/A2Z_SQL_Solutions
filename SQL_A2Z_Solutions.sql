...
ALTER TABLE STUDENT
ADD Monitor_ID VARCHAR(10);

UPDATE STUDENT
SET Addres = CASE 
    WHEN Adm_No = 'ROSE00023' THEN 'Delhi'
    WHEN Adm_No = 'ROSE00024' THEN 'Delhi'
    WHEN Adm_No = 'ROSE00040' THEN 'Chennai'
    WHEN Adm_No = 'ROSE00041' THEN 'Delhi'
    WHEN Adm_No = 'ROSE00058' THEN 'Pune'
    WHEN Adm_No = 'ROSE00102' THEN 'Noida'
    WHEN Adm_No = 'ROSE00144' THEN 'Mumbai'
    WHEN Adm_No = 'ROSE00145' THEN 'Mumbai'
    WHEN Adm_No = 'ROSE00172' THEN 'Sikkim'
    WHEN Adm_No = 'ROSE00331' THEN 'Chennai'
    WHEN Adm_No = 'ROSE00335' THEN 'Noida'
    ELSE Addres                               -- Optional, in case Adm_No does not match any condition
END;
...
INSERT INTO Student                                                       -- Inserting a ROW in Student Table
Values ('ROSE00335', '9/4/2023', 'Manish Kumar', 'M', 'Ranjan Kumar', 'Barahat', 9060609777, 9, 350)
...
Drop Index Student.idx_StudName;  -- Drop (Delete) an index from a table

DROP INDEX idx_Student_Name_Class ON STUDENT;
...
From Student
INNER JOIN Exams ON Student.Adm_No = Exams.Adm_No; -- INNER JOIN from Student Table rows with Exams Table
...
Order By Avg(Fee) Desc;   -- Average fee of students where Average fee is more than 300, arranged in Descending order
