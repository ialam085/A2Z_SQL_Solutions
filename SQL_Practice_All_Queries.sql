...
INSERT INTO student (Adm_No, DOJ, Stud_Name, Guardian_Name, Addres, Contact_No, Class, Fee)
...
SELECT MAX(Marks_Obtained) AS ThirdHighestMarks   -- SECOND-highest marks obtained in Exams table
FROM EXAMS
WHERE Marks_Obtained < (
